def init(users: list = [], categories: list = [], photos: list = [], comments: list = []) -> None:
    """
    ...
    def create_user(username: str, email: str, password: str, avatar: str, role: str, isBlocked: bool) -> dict:
            ...
            file.write(f"{last_user_id};{username};{email};{password};{avatar};{role};{isBlocked}\n")
    ...
    def create_photos(description: str, publishedDate: str, image: str, likes: int, rating: float, categoryID: int, creatorID: int) -> dict:
        ...
        file.write(f"{last_photo_id};{description};{publishedDate};{image};{likes};{rating};{categoryID};{creatorID}\n")
    ...
    def update_user(userID: int, username: str, email: str, password: str, avatar: str, role: str, isBlocked: bool) -> dict:
        ...
        for line in lines:
            ...
            if int(user[0]) == userID:
                ...
                file.write(f"{user[0]};{user[1]};{user[2]};{user[3]};{user[4]};{user[5]};{user[6]}")
            else:
                file.write(line)
    ...
    def update_photo(photoID: int, description: str, publishedDate: str, image: str, likes: int, rating: float, categoryID: int, creatorID: int) -> dict:
        ...
        for line in lines:
            ...
            if int(photo[0]) == photoID:
                ...
                file.write(f"{photo[0]};{photo[1]};{photo[2]};{photo[3]};{photo[4]};{photo[5]};{photo[6]};{photo[7]}")
            else:
                file.write(line)
    ...
    def delete_photo(photoID: int, description: str, publishedDate: str, image: str, likes: int, rating: float, categoryID: int, creatorID: int) -> None:
    ...
    def delete_user(userID: int, username: str, email: str, password: str, avatar: str, role: str, isBlocked: bool) -> None:
